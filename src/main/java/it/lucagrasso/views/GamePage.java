...
public class GamePage extends BorderPane {
    ...
    public GamePage(String filename, String characterColor){
        ...
        BackgroundImage myBI = new BackgroundImage(new Image("resource/img/gamepage.png", 800, 600, false, true),
...
//        rec0.setStroke(Color.BLACK);
        Image axe0 = new Image("resource/img/axe0.png", 50, 50, false, false);
...
//        rec1.setStroke(Color.BLACK);
        Image axe1 = new Image("resource/img/axe1.png", 50, 50, false, false);
...
//        rec2.setStroke(Color.BLACK);
        Image axe2 = new Image("resource/img/axe2.png", 40, 40, false, false);
...
//        rec3.setStroke(Color.BLACK);
        Image pen = new Image("resource/img/star.png", 40, 40, false, false);
