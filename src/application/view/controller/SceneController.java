...
public class SceneController {
    ...
    public SceneController(String nameScene, Stage stage, int width, int height) {
        this.nameScene = "/application/view/fxml/" + nameScene + ".fxml";
    ...
    public void switchToScene(String nameScene, Stage stage) throws IOException {
        ...
        Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/application/view/fxml/" + nameScene + ".fxml")));
